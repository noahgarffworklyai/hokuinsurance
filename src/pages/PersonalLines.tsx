...
const PersonalLines = () => {
  return (
    <>
      <SEO
        title="Personal Insurance Hawaii | Home, Auto & Umbrella | Hoku Insurance"
        description="Protect your home, auto, and personal assets in Hawaii with tailored insurance from Hoku Insurance. Homeowners, condo, renters, hurricane, flood & umbrella coverage in Kailua-Kona."
