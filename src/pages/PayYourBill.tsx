...
const PayYourBill = () => {
  return (
    <>
      <SEO
        title="Pay Your Bill | Hoku Insurance | Kailua-Kona, Hawaii"
        description="Pay your insurance bill with Hoku Insurance LLC. Call (808) 809-7670 to speak with our Kailua-Kona team for secure, personal payment assistance."
        canonical="/pay-your-bill"
      />
