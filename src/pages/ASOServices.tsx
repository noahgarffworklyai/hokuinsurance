...
const advantages = [
  { icon: ShieldCheck, title: "Retain Total Control", desc: "Unlike restrictive co-employment models that take over your business identity, Hoku HR Services leaves you as the sole employer of record. You maintain your own federal tax ID and complete autonomy over your hiring and operational decisions, backed by a powerful platform and a dedicated team keeping your back office running smoothly." },
  { icon: MapPin, title: "Local Expertise for Local Laws", desc: "Hawaii has some of the most unique and stringent labor laws in the nation. Hoku HR Services is staffed by professionals who live and work here. We understand the nuances of the Hawaii Prepaid Healthcare Act and local labor nuances that mainland providers often overlook." },
  { icon: TrendingUp, title: "Cost-Effective Scalability", desc: "Hiring a full-time HR Director, a Payroll Specialist, and a Compliance Officer is financially out of reach for many small to mid-sized firms. Hoku HR Services gives you access to a full team of specialists for a fraction of the cost of one executive salary." },
  { icon: Link2, title: "Integrated Synergy with Hoku Insurance", desc: "Because Hoku HR Services is our sister company, there is a seamless \"Hokuleʻa Star\" alignment between your insurance needs and your workforce management. We can coordinate workers' comp claims data and benefits administration with precision, reducing data silos and administrative friction." },
];
...
const ASOServicesPage = () => {
  return (
    <>
      <SEO
        title="Payroll & HR Services Hawaii | Human Capital Management | Hoku HR Services"
      ...
      <ServicePageLayout title="Hoku HR Services: Human Capital Management for Hawaii Businesses" subtitle="Sister Company" heroImage={teamMeeting}>
        ...
        <p className="text-muted-foreground leading-relaxed mb-12">
          Hoku HR Services offers payroll, HR, compliance, and employee management solutions. While Hoku Insurance protects your physical and financial assets, Hoku HR Services protects your time and your workplace culture. With our scalable platform and expert support, you maintain full control over your workforce while offloading high-stress, technical back-office administration.
        </p>
        ...
        <h2 className="text-2xl sm:text-3xl font-heading font-bold text-foreground mb-8">
          The Hoku HR Services Advantage
        </h2>
        ...
        <div className="bg-primary rounded-lg p-8 lg:p-10 text-center">
          ...
          <p className="text-white/70 leading-relaxed mb-6 max-w-2xl mx-auto">
            Don't let the weight of administration dim your business's potential. By choosing Hoku HR Services for your ASO needs, you're investing in the peace of mind that comes from knowing your back office is as solid as the island lava rock.
          </p>
