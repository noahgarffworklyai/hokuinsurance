...
const CommercialInsurance = () => {
  return (
    <>
      <SEO
        title="Commercial Insurance Hawaii | Business Coverage | Hoku Insurance"
        description="Comprehensive commercial insurance for Hawaii businesses. General liability, commercial property, workers' comp, commercial auto & professional liability from Hoku Insurance in Kailua-Kona."
        canonical="/commercial-insurance"
      />
