    ...
    <ServicePageLayout title="Commercial Insurance: Protecting the Heart of Your Business" subtitle="Insurance Solutions">
      ...
      <div className="bg-primary rounded-lg p-8 lg:p-10 text-center">
        ...
        <p className="text-white/70 leading-relaxed mb-6 max-w-2xl mx-auto">
          Don't leave the future of your business to chance. Let the experts at Hoku Insurance provide the "Hokulea Star" guidance you need to navigate your commercial insurance options with confidence.
        </p>
