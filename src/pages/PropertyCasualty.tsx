...
const PropertyCasualty = () => {
  return (
    <ServicePageLayout title="Property & Casualty: Specialized Solutions for Island Life" subtitle="P&C Insurance">
