...
const PropertyCasualty = () => {
  return (
    <>
      <SEO
        title="Property & Casualty Insurance Hawaii | Hurricane, Flood & Lava | Hoku Insurance"
        description="Specialized property and casualty insurance for Hawaii. Hurricane, flood, lava zone, wildfire & liability coverage tailored for island living by Hoku Insurance in Kailua-Kona."
        canonical="/property-casualty"
      />
