        ...
        <div className="grid md:grid-cols-3 gap-16">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm leading-[1.8]">
              Full-service commercial and personal lines Property & Casualty insurance agency serving Hawaii with Aloha.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h4 className="font-heading font-bold text-sm tracking-[0.25em] uppercase text-foreground mb-6">
              Quick Links
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-3.5">
              <li className="flex items-start gap-3">
                ...
                <a
                  href="https://maps.google.com/?q=75-170+Hualalai+Rd+Ste+A100,+Kailua-Kona,+HI+96740"
                  target="_blank"
              ...
              <li className="flex items-start gap-3 pt-3 border-t border-border/30 mt-1">
                <span className="text-muted-foreground text-sm">To pay your bill, please call us.</span>
              </li>
            </ul>
          </div>
        </div>
