      ...
      >
        <div className="bg-primary text-white">
          <div className="container py-1.5 flex items-center justify-between text-[11px] font-medium tracking-wide">
            ...
            <a href="tel:+18088097670" className="flex items-center gap-1.5 hover:text-white/80 transition-colors">
      ...
      >
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="hidden md:grid grid-cols-[1fr_auto_1fr] items-center gap-4 relative">
            ...
            <Link
              to="/contact"
              className="absolute right-0 gradient-gold text-white md:px-3 md:py-1.5 lg:px-5 lg:py-2 md:text-[10px] lg:text-[11px] font-semibold md:tracking-[0.1em] lg:tracking-[0.15em] uppercase rounded hover:shadow-md hover:shadow-accent/20 transition-all duration-300"
            >
              Get a Quote
            </Link>
